...
function filterStudentsByGrade(students, grade) {
  ...
  console.clear();
  console.trace("Завдання: 1 ==============================");

  const gradeIn = grade;
  const studentsByGrade = students.filter(({grade} = value) => 
    grade === gradeIn);
    
  studentsByGrade.forEach(element => {
...
function logArrayElements(arr) {
  ...
  if (Array.isArray(arr)) {
    for (let index = 0; index < arr.length; index++) {
      let value = arr[index];
      console.log("Eлемент ", index, ": ", value )};
      
      return;

  } else {console.error("Аргумент має бути масивом!");
return null};
}
...
function warnAboutMaxArrayLength(arr, maxLength) {
  ...
  } else {console.error("Перший аргумент має бути масивом, другий аргумент має бути числом!");
return null;}
}
...
function compareArrays(arr1, arr2) {
  ...
  const arr1Sort = arr1.sort((a, b) => 
  {return (a > b ? 1 : -1);})

  const arr2Sort = arr2.sort((a, b) => 
  {return (a > b ? 1 : -1);})

  const arr1End = JSON.stringify(arr1Sort);
  const arr2End = JSON.stringify(arr2Sort);

  console.assert(arr1End === arr2End, "Масиви не однакові");
...
function buildMatrix(size) {
  ...
  } else {console.error("Аргумент має бути числом!");
return null;}
}
...
function traceBackward(n) {
  ...
  if (n > 1) {
    traceBackward(n - 1);
  } else {console.trace(traceBackward);}
...
function validateUserInput(userInput) {
  ...
  console.assert(username !== "", "Помилка: ім'я користувача відсутнє!");
  console.assert(password !== "", "Помилка: пароль відсутній!");
...
function calculateTotalPrice(products) {
  ...
  let countTime = "calculateTotalPrice";
  console.time(countTime);

  let total = products.reduce((total, {price} = element) => total + price, 0);
...
function countVowelsAndConsonants(word) {
  ...
  for (let letter of word) {
    ...
    (vowels.includes(letter) ? countVowels++ : countConsonants++);
  };

  console.log(word);
  console.log("Голосних літер:", countVowels,"Приголосних літер:", countConsonants);
